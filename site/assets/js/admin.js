...
import { firebase, whoAmI, call } from './fb.js?v=53bc2699';

/* Значение подставляет сборщик, беря его прямо из serve.py: держать одно
   и то же число в двух файлах руками уже подвело. 14.09.2026 я поднял его
   в сервере и забыл здесь, и у заказчицы неделю висела плашка «сайт
