...
PHOTOS = os.path.join(ROOT, 'photos')               # оригиналы, в репозиторий не входят
...
def read_hero(site):
    ...
    # Пустое значение тоже значение: если хозяйка сайта стёрла приписку и сохранила,
...
# которые правит хозяйка сайта, нет: жирное начертание в обложке главной было
